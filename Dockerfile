...
RUN apt-get -y update && apt-get -y install wget && apt-get -y install --no-install-recommends apt-utils && apt-get -y install build-essential && apt-get -y install dialog apt-utils
